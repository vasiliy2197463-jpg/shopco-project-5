  ...
  },
  {
    ...
    availableColors: [
      ...
      },
      {
        name: "Blue/White",
        hex: "#063AF5",
        image: "/images/products/variants/product-3-blue-white.png",
        images: ["/images/products/variants/product-3-blue-white.png", "/images/products/models/product-3-blue-white-front.png"]
      },
      {
        name: "Yellow/White",
        hex: "#F5DD06",
        image: "/images/products/variants/product-3-yellow-white.png",
        images: ["/images/products/variants/product-3-yellow-white.png", "/images/products/models/product-3-yellow-white-front.png"]
      }
    ],
    availableSizes: ["Small", "Medium", "Large", "X-Large"],
    stock: 120,
  ...
  },
  {
    ...
    availableColors: [
      ...
      },
      {
        name: "Blue",
        hex: "#0000FF",
        image: "/images/products/variants/product-7-blue.png",
        images: ["/images/products/variants/product-7-blue.png", "/images/products/models/product-7-blue-front.png"]
      },
      {
        name: "Black",
        hex: "#000000",
        image: "/images/products/variants/product-7-black.png",
        images: ["/images/products/variants/product-7-black.png", "/images/products/models/product-7-black-front.png"]
      },
      {
        name: "Purple",
        hex: "#7D06F5",
        image: "/images/products/variants/product-7-purple.png",
        images: ["/images/products/variants/product-7-purple.png", "/images/products/models/product-7-purple-front.png"]
      }
    ],
    availableSizes: ["Small", "Medium", "Large", "X-Large"],
    stock: 75,
