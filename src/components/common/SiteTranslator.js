...
const RU = {
  ...
  "Go to Checkout": "Перейти к оформлению", "Continue Shopping": "Продолжить покупки",
  ...
  "You Might Also Like": "Вам также может понравиться", "All Reviews": "Все отзывы", "Write a Review": "Оставить отзыв",
