...
const columns = {
  ru: [
    ...
    ["Информация", [["Таблица размеров", "/info/sizes"], ["Оплата", "/info/payments"], ["Конфиденциальность", "/info/privacy"]]],
  ],
  en: [
    ...
    ["Information", [["Size guide", "/info/sizes"], ["Payments", "/info/payments"], ["Privacy", "/info/privacy"]]],
  ],
};
